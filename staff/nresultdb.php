...
$update = mysqli_query($con,"UPDATE bookings SET result='negetive' WHERE id=$userid AND result=''");
$update = mysqli_query($con,"UPDATE bookings SET status='result entered' WHERE id=$userid AND result=''");
