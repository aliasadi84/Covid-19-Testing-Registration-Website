...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=750122520ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sourcecodester_dadb&table=doctor">`sourcecodester_dadb`.`doctor`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sourcecodester_dadb&table=patient">`sourcecodester_dadb`.`patient`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sourcecodester_dadb&table=staff">`sourcecodester_dadb`.`staff`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sourcecodester_dadb&table=bookings">`sourcecodester_dadb`.`bookings`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sourcecodester_dadb&table=doctorschedule">`sourcecodester_dadb`.`doctorschedule`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="30657d4833664b25662e67653f217c3f">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="sourcecodester_dadb" targettable="staff">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `staff`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sourcecodester_dadb" targettable="doctor">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `doctor`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sourcecodester_dadb" targettable="staff">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `staff`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sourcecodester_dadb" targettable="patient">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `patient`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sourcecodester_dadb" targettable="doctor">
                            <div class="action_content">
